...
export const NAV_GROUPS = [
  ...
  { id: "resources", items: ["documentation", "settings"] },
];
// Служебные пункты (внизу мобильного меню). 2026-09-08: settings поднят в группу
// Resources (под Documentation); внизу сайдбара — виджет-индикатор системы.
export const NAV_BOTTOM = ["support"];
