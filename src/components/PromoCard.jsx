...
function PromoCard({ id }) {
  ...
  // Книга: CSS-обложка в стиле платформы (аудит M3: фото O'Reilly с носорогом —
  // инородный объект; была CSS-обложка в хронике) + CTA на Amazon (новая вкладка).
  if (p.bookLayout) {
    return (
      <article className="card promo promo--book">
        <div className="promo--book__glow" aria-hidden="true" />
        <div className="promo--book__cover">
          {/* Оригинальная обложка O'Reilly (носорог) — фидбек 2026-09-08: вернуть фото */}
