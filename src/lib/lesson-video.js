...
import claudeIconUrl from "../assets/claude-icon.webp?inline";
import copilotIconUrl from "../assets/copilot-icon.webp?inline";
...
export const LESSON_VIDEO_IDS = {
  ...
  // Логотип-обложка — официальный Claude (webp, как в TechLogos) с 2026-09-15.
  claude: {
...
const COVER_LOGOS = {
  ...
  // Курс Claude Code (18 уроков). Логотип-обложка — официальный Claude (webp, как в TechLogos; 2026-09-15).
  claude: {
    image: claudeIconUrl,
    vb: 24,
    path: "",
  },
  // Курс Cursor: новая форма (2026-09-15) — как в TechLogos: тёмная шестигранная плашка + бирюзовый wireframe-куб.
  cursor: {
    color: "#65e4db",
    vb: 24,
    path: "",
    ...
    extraPaths: [
      {
        color: "#0b1119",
        d: "M12 1.1l9.3 6.35v9.1L12 22.9l-9.3-6.35v-9.1L12 1.1z",
      },
    ],
  },
  // GitHub Copilot: официальный лого (webp, как в TechLogos) — для будущих обложек курса.
  copilot: {
    image: copilotIconUrl,
    vb: 24,
    path: "",
  },
  python: {
...
function coverSvg(name, logo, num) {
  ...
  ${
    logo.image
      ? `<image x="64" y="196" width="206" height="206" preserveAspectRatio="xMidYMid meet" href="${logo.image}"/>`
