...
export const LESSON_VIDEO_IDS = {
  ...
  // Курс Vue (22 урока). 22-й (финальный проект) — без RU-видео: заглушка.
  vue: {
    ...
    16: "_funL-qPp5Q", // Laracasts (RU) — Эпизод 15: именованные слоты (11:27)
    ...
    // 22 — финальный проект SPA (Router + Pinia): подходящего RU-видео нет → заглушка
  },
};
export const TECHS_WITH_VIDEO = ["html", "css", "javascript", "react", "vue"];
