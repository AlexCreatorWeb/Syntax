...
export function buildSystemPrompt(techName) {
  ...
  return [
    ...
    `- Video lessons: the HTML and CSS courses include a video walkthrough for every lesson (built-in YouTube player); the other courses are text-only for now.`,
